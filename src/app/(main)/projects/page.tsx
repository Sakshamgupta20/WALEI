...
export const metadata: Metadata = {
  title: "Projects",
  description: "Research projects and collaborative initiatives from the WALEI community.",
};
      ...
      <section className="relative bg-[var(--dark)] py-12 md:py-16 overflow-hidden">
        ...
        <div className="relative max-w-[1200px] mx-auto px-5 md:px-8">
          ...
          <p className="text-lg text-gray-400 max-w-2xl leading-relaxed">
            Research projects and collaborative initiatives powered by the WALEI network.
          </p>
        </div>
      </section>
      ...
      <section className="py-32 md:py-40 bg-white">
        <div className="max-w-[1200px] mx-auto px-5 md:px-8 text-center">
          <div className="w-20 h-20 rounded-2xl bg-[var(--gold)]/10 flex items-center justify-center mx-auto mb-8">
            <FolderOpen size={36} className="text-[var(--gold)]" />
          </div>
          <h2 className="text-3xl md:text-4xl font-light text-gray-900 mb-4">
            Coming Soon
          </h2>
          <p className="text-gray-500 max-w-lg mx-auto leading-relaxed">
            We are building a showcase of collaborative research projects and innovation
            initiatives. Check back soon for exciting developments.
          </p>
        </div>
      </section>
    </>
